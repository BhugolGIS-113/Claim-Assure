...
class DumpExcel(models.Model):
    ...
    CaseNo = models.TextField(max_length=255 , blank = True , null = True)
    ClaimNo = models.TextField(max_length=255 , blank = True , null = True)
    RegistrationNumber = models.TextField(max_length=255 , blank = True , null = True)
    NHPMId = models.TextField(max_length=255 , blank = True , null = True)
    FamilyId = models.TextField(max_length=255 , blank = True , null = True)
    PatientDistrict = models.TextField(max_length=255 , blank = True , null = True)
    Gender = models.TextField(max_length=255 , blank = True , null = True)
    Age = models.IntegerField( )
    CategoryDetails = models.TextField(max_length=255 , blank = True , null = True)
    ProcedureDetails = models.TextField(max_length=255 , blank = True , null = True)
    CaseType = models.TextField(max_length=255 , blank = True , null = True)
    CaseStatus = models.TextField(max_length=255 , blank = True , null = True)
    HospitalName = models.TextField(max_length=255 , blank = True , null = True)
    HospitalCode = models.TextField(max_length=255 , blank = True , null = True)
    HospitalDistrict = models.TextField(max_length=255 , blank = True , null = True)
    PreauthAmount =models.TextField(max_length=255, blank= True , null = True)
    ClaimInitaiatedAmount = models.TextField(max_length=255, blank= True , null = True)
    CPDApprovedAmount = models.TextField(max_length=255, blank= True , null = True)
    ClaimApprovedAmount = models.TextField(max_length=255 , blank = True , null = True)
    AssignedFlag = models.TextField(max_length=255 , blank = True , null = True)
    AssignedUser = models.TextField(max_length=255 , blank = True , null = True)
    AssignedGroup = models.TextField(max_length=255 , blank = True , null = True)
    IPNumber = models.TextField(max_length=255, blank= True , null = True)
    PreauthApprovedAmount = models.TextField(max_length=255, blank= True , null = True)

    PreauthApproveDate =  models.TextField(max_length=255, blank= True , null = True)
    PreauthRejectedDate = models.TextField(max_length=255, blank= True , null = True)
    SurgeryDate =models.TextField(max_length=255, blank= True , null = True)
    DeathDate =models.TextField(max_length=255, blank= True , null = True)
    DischargeDate = models.TextField(max_length=255, blank= True , null = True)
    ClaimSubmittedDate = models.TextField(max_length=255, blank= True , null = True)
    ActualClaimSubmittedDate =models.TextField(max_length=255, blank= True , null = True)
    IPRegistrationDate = models.TextField(max_length=255, blank= True , null = True)
    AdmissionDate = models.TextField(max_length=255, blank= True , null = True)
    PreauthDate = models.TextField(max_length=255, blank= True , null = True)
    ActualRegistrationDate = models.TextField(max_length=255, blank= True , null = True)
